...
//==============================================================================
{
  ...
  protected:
    ...
    virtual bool ComputeLighting( vector<GLVertex> &verts ) { return false; }
  ...
  private:
    ...
    void  processPolygon( vector<GLVertex> &poly, int * nrPtr ); //edit
...
#define glEnd(ptr)                 theGLRenderer->End(ptr)
